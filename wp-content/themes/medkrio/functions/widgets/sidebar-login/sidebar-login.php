...
<?php if ( get_option('users_can_register') ) : ?>
 <li><a href="<?php echo home_url();  ?>/wp-register.php"><?php echo __('Register', 'care'); ?></a></li>
<?php endif; ?>
 <li><a href="<?php echo home_url();  ?>/wp-login.php?action=lostpassword"><?php echo __('Recover password', 'care'); ?></a></li>
 </ul>
<?php endif;
