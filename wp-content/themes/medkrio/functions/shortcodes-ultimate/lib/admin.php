						...
						<table class="fixed">
							...
							<tr>
								<td>
									...
									<p><label><input type="checkbox" name="su_disabled_scripts[flowplayer]" <?php echo ( isset( $disabled_scripts['flowplayer'] ) ) ? $checked : ''; ?> /> <?php _e( 'Disable', 'shortcodes-ultimate' ); ?> Flow Player</label></p>
									<p><label><input type="checkbox" name="su_disabled_scripts[tweets]" <?php echo ( isset( $disabled_scripts['tweets'] ) ) ? $checked : ''; ?> /> <?php _e( 'Disable', 'shortcodes-ultimate' ); ?> Tweets</label></p>
